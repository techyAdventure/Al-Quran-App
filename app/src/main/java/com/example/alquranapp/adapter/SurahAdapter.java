...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalAya.setText("Ayah : "+String.valueOf(list.get(position).getNumberOfAyahs()));
    ...
    public void filter_main(ArrayList<Surah> details){
        list = details;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView, SurahListener surahListener) {
            ...
            totalAya = itemView.findViewById(R.id.total_ayat);
